...
The morphological gradient is based on the difference between an image after [dilation](./dilation 'internal link on dilation') and the same image after [erosion](./erosion 'internal link on erosion').
